...
export const Results = () => {
  return (
    <section className="flex flex-col gap-4 p-2.5  bg-black">
      <div className="mx-auto max-w-7xl w-full">
        <h2 className="font-bold font-actay text-center text-3xl md:text-5xl mb-10 text-white">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 p-8">
          ...
          >
            <button className="w-full bg-secondary hover:scale-105 transition-all duration-500 h-20 font-proxima uppercase text-black text-2xl lg:text-3xl col-span-full rounded-full">
              Book a call
            </button>
          </a>
          <a
